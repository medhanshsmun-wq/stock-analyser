...
function App() {
  ...
  const [splitTicker, setSplitTicker] = useState(null); // Second ticker for comparison
  ...
  const loadChat = (chat) => {
    ...
    // Load the first or explicitly active ticker
            ...
            <div>
              ...
              <div className="action-block">
                ...
                <div className="action-desc">
                  ...
                  <span style={{ fontSize: '12px', color: '#4a5568', marginTop: '4px', display: 'block' }}>Best for: {ml_overview.action_matrix.profiles.join(' · ')}</span>
                </div>
              </div>
